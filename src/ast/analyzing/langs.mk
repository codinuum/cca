...
INCLS = -I $(UTIL_DIR) -I $(COMMON_DIR) -I $(PARSER_DIR) -I $(OTREEDIFF_DIR) -I $(ENGINE_DIR) $(EXTRA_INCLS) -I $(LANGS_COMMON_DIR)

include $(ANALYZER_DIR)/subs.mk

OTHER_LIBS_DEP = $(COMMON_OBJS_DEP_P) $(OTREEDIFF_OBJS_DEP) $(ENGINE_OBJS_DEP)
...
-include $(SPEC_OBJ:%.cmo=$(DEP)/%.d) $(OBJS_P:%.cmo=$(DEP)/%.d) $(MLI:%.mli=$(DEP)/%.di)
endif
endif
